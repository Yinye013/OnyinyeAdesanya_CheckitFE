...
//   const [activeIcon, setActiveIcon] = useState("home"); // Set "home" as the default active icon

//   return (
//     <div className="flex flex-col items-center bg-slate-500 h-fit gap-16 pt-8">
//       {icons.map(({ component: Icon, name }) => (
//         <div
//           key={name}
//           onClick={() => setActiveIcon(name)}
//           className={`p-3 rounded-md ${
//             activeIcon === name ? "bg-white text-slate-500" : ""
//           }`}
//         >
//           <Icon size={20} />
//         </div>
